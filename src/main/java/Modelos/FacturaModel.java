...
/*   3:    */ import Modelos.ImpuestoProducto;
/*   4:    */ import Modelos.ImpuestoValor;
/*   5:    */ import Modelos.Producto;
/*   6:    */ import Modelos.SubtotalImpuesto;
/*   7:    */ //import ec.gob.sri.comprobantes.sql.ImpuestoValorSQL;
/*   8:    */ //import ec.gob.sri.comprobantes.sql.ProductoSQL;
/*   9:    */ import Facturacion.Util.TipoImpuestoEnum;
/*  10:    */ import Facturacion.Util.TipoImpuestoIvaEnum;
/*  11:    */ import Facturacion.Util.ValidadorCampos;
...
/* 144:    */     try
/* 145:    */     {
/* 146:161 */       prod = new  Producto();//(Producto)new ProductoSQL().obtenerProducto(codigoPrincipal, codigoAuxiliar, descripcion).get(0);
/* 147:    */     
                        prod.setCantidad(1.00);
                        prod.setCodigo(11);
                        prod.setIva("12");
...
/* 319:291 */       Producto prod = new Producto(); /// llenar producto desde fuente de datos
                    prod.setCodigo(1);
...
/* 365:    */       {
/* 366:343 */         ImpuestoValor iv = new ImpuestoValor();
                        iv.setCodigo("1");
                        iv.setDescripcion("descripcion");
                        iv.setPorcentaje(12.00);
...
/* 466:    */     {
/* 467:436 */       ImpuestoValor iv = new ImpuestoValor();
                                iv.setCodigo("1"); /// llenar modeo desde base de datos
...
/* 589:    */         try
/* 590:    */         {
/* 591:574 */           iv =  new ImpuestoValor();
                        iv.setCodigo("2");// llenar desde base de datos
/* 592:    */         }
