...
/*   4:    */ import Modelos.ClaveContingencia;
/*   5:    */ import Modelos.ConfiguracionDirectorio;
/*   6:    */ import Modelos.Emisor;
/*   7:    */ import Modelos.Factura.Factura;
/*   8:    */ import Modelos.Guia.GuiaRemision;
/*   9:    */ import Modelos.NotaCredito.NotaCredito;
/*  10:    */ import Modelos.NotaDebito.NotaDebito;
/*  11:    */ import Modelos.Retencion.ComprobanteRetencion;
...
/*  15:    */ import Facturacion.xml.Java2XML;
/*  16:    */ import Facturacion.xml.LectorXPath;
/*  17:    */ import Facturacion.xml.ValidadorEstructuraDocumento;
/*  18:    */ import Facturacion.xml.XStreamUtil;
/*  19:    */ import recepcion.RespuestaSolicitud;
/*  20:    */ import autorizacion.Autorizacion;
...
/*  80: 98 */ Object archivoCreado = null;
                    try
/*  82:    */     {
...
/* 205:    */     try
/* 206:    */     {
/* 207:251 */       String dirFirmados = "";// OBTENER DESDE FUENTE DE DATOS//new ConfiguracionDirectorioSQL().obtenerDirectorio(DirectorioEnum.FIRMADOS.getCode()).getPath();
/* 208:    */       
/* 209:    */ 
...
/* 462:575 */    boolean resultado = false;
/* 463:    */     try
/* 464:    */     {
