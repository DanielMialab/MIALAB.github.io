...
/*   3:    */ import Modelos.Respuesta;
/*   4:    */ //import ec.gob.sri.comprobantes.sql.RespuestaSQL;
/*   5:    */ import recepcion.Comprobante;
/*   6:    */ //import ec.gob.sri.comprobantes.ws.Comprobante.Mensajes;
/*   7:    */ import recepcion.Mensaje;
/*   8:    */ import recepcion.RecepcionComprobantesOffline;
/*   9:    */ import recepcion.RecepcionComprobantesOfflineService;
/*  10:    */ import recepcion.RespuestaSolicitud;
/*  11:    */ import recepcion.RespuestaSolicitud.Comprobantes;
...
/*  21:    */ {
/*  22:    */   private static RecepcionComprobantesOfflineService service;
...
/*  32: 40 */     service = new RecepcionComprobantesOfflineService(url, qname);
/*  33:    */   }
/*  34:    */   
...
/*  41: 47 */       service = new RecepcionComprobantesOfflineService(url, qname);
/*  42: 48 */       return null;
/*  43:    */     }
...
/*  58:    */     try
/*  59:    */     {
/*  60: 71 */       RecepcionComprobantesOffline port = service.getRecepcionComprobantesOfflinePort();
...
/*  76:    */     try
/*  77:    */     {
/*  78: 98 */       RecepcionComprobantesOffline port = service.getRecepcionComprobantesOfflinePort();
/*  79:    */       
...
/*  95:    */     try
/*  96:    */     {
/*  97:125 */       RecepcionComprobantesOffline port = service.getRecepcionComprobantesOfflinePort();
